      ...
      cachedApp = createApp({
        ...
        config: {
          ...
          llm: {
            ...
            LLM_HOOK_MAX_REQUESTS: env.LLM_HOOK_MAX_REQUESTS,
            LLM_TALK_SELECTOR: env.LLM_TALK_SELECTOR,
            TYPESAFE_API_KEY: env.TYPESAFE_API_KEY,
            TYPESAFE_MODEL: env.TYPESAFE_MODEL,
            TYPESAFE_MIN_CONFIDENCE: env.TYPESAFE_MIN_CONFIDENCE,
            TYPESAFE_GAME_OVER_MIN_CONFIDENCE: env.TYPESAFE_GAME_OVER_MIN_CONFIDENCE
          }
        }
      });
    }
